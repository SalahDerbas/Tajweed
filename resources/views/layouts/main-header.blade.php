 ...
 header start-->
        <nav class="admin-header navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            ...
            <div class="text-left navbar-brand-wrapper">
                <a class="navbar-brand brand-logo" href="index.html"><img src="{{asset('assets/images/Logo SD1.png')}}" alt="">
                {{trans('main_trans.Tajweed')}}</a>
                <!-- <a class="navbar-brand brand-logo-mini" href="index.html"><img src="{{asset('assets/images/Logo SD1.png')}}"
                        alt=""></a> -->
            </div>
            <!-- Top bar left -->
            ...
            <div class="dropdown-menu">
                ...
                <li class="nav-item dropdown mr-30">
                    <a class="nav-link nav-pill user-avatar" data-toggle="dropdown" href="#" role="button"
                        ...
                        <img src="{{asset('assets/images/Logo SD1.png')}}" alt="avatar">
                    </a>
